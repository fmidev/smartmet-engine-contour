...
namespace Contour
{
class ShiftedDataMatrixAdapter : public Trax::Grid
{
 public:
  ShiftedDataMatrixAdapter() = delete;

  ShiftedDataMatrixAdapter(NFmiDataMatrix<float>& theMatrix,
  ...
  void set(long i, long j, double z) override { itsMatrix[(i + itsShift) % itsNX][j] = z; }
...
};  // class ShiftedDataMatrixAdapter
}  // namespace Contour
}  // namespace Engine
}  // namespace SmartMet
